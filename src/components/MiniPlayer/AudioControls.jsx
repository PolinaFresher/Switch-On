  ...
  return (
    <div className={styles.audioControls}>
      ...
      <button
        ...
        onClick={() => {navigate(ROUTES.PLAYER); LyricsRequest.getLirycs(track.id)}} >
      ...
      <button
        ...
        {state ? <div className={Theme.isThemeDark() ? styles.volumeBoxActive : styles.volumeBoxActiveL}>
      ...
      <button onClick={() => navigate(ROUTES.PLAYER)}
        type="button"
